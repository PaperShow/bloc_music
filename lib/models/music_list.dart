...
//
//     final musicList = musicListFromJson(jsonString);
import 'dart:convert';

MusicList musicListFromJson(String str) => MusicList.fromJson(json.decode(str));

String musicListToJson(MusicList data) => json.encode(data.toJson());
